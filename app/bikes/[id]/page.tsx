          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-2xl font-bold">₹{typeof window === "undefined" ? bike.price : bike.price.toLocaleString("en-IN")}</span>
                {bike.isElectric && bike.subsidyPrice && (
                  <span className="text-lg text-gray-500 line-through">
                    ₹{typeof window === "undefined" ? bike.subsidyPrice : bike.subsidyPrice.toLocaleString("en-IN")}
                  </span>
                )}
              </div>
              {bike.isElectric && bike.subsidyPrice && (
